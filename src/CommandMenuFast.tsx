...
export const CommandMenuFast = () => {
  const [open, setOpen] = useState(false);
  const [query, setQuery] = useState("");
  const matches = useFilteredItems(data, query);
  ...
  return (
    ...
    >
      <Dialog.Trigger asChild>
        ...
        >
          <SearchIcon /> Menu with disabled artificial slowdown
        </IconButton>
      </Dialog.Trigger>
      <Portal>
        <Dialog.Positioner alignItems="start" top="5%" bottom="5%">
          ...
          >
            ...
            >
              ...
              >
                <List matches={matches} query={query} disableSlowdown />
              </Combobox.Content>
            </Combobox.Root>
          </Dialog.Content>
        </Dialog.Positioner>
